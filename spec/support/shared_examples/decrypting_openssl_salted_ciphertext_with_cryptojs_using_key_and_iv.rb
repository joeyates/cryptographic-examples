...
shared_examples 'decrypting openssl salted ciphertext with CryptoJS using key and iv' do
  context 'decrypting openssl salted ciphertext with CryptoJS using key and iv' do
